...
_SLACK_REDIRECT_URI  = "https://lancellmot.hexcaliper.com/page/api/slack/callback"
_SLACK_USER_SCOPES   = (
...
_TEAMS_REDIRECT_URI = "https://lancellmot.hexcaliper.com/page/api/teams/callback"
